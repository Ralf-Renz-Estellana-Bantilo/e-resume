...
const DesktopView = () => {
    ...
    const handleDownload = (): void => {
        ...
        element.download =
            'Ralf Renz Bantilo - Software Development Team Leaded Resume';
    ...
    return (
        <div
            className={`${quicksand.className} bg-background-primary relative flex min-h-screen w-full max-lg:flex max-lg:flex-col`}
        >
            {/* LEFT PANEL */}
            <div
            ...
            >
                <div className="flex flex-col gap-3 ">
                    ...
                    >
                        <motion.div
                            className="flex items-center justify-center transition-colors ease-in-out border-2 border-red-800 rounded-full hover:border-red-500"
                            variants={item}
                        ...
                        >
                            <motion.h3
                                className="text-2xl font-bold text-center text-background-primary tiktok-effect"
                                variants={item}
                            >
                                RALF RENZ BANTILO
                            </motion.h3>
                    ...
                    <Divider className="m-0 "></Divider>
                    <motion.div
                        className="flex flex-col border-2 rounded-lg border-slate-600 text-background-primary"
                        variants={container}
                        initial="hidden"
                        animate="visible"
                    >
                        <div className="flex justify-center px-2 py-1 border-2 border-transparent border-b-slate-600">
                            ...
                            {personalInformation.map((info, i) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <p
                                            style={{ flex: 1 }}
                                            className="text-sm font-semibold text-background-primary"
                                        >
                                            {info.label}
                                        </p>
                                    </motion.div>
