...
const qualifications: IQualification[] = [
    ...
    },
    {
        ...
        description: [
            'Proficient in using Claude Code, ChatGPT, GitHub Copilot, and other AI-powered development tools.',
            'Experienced in AI-assisted code generation, debugging, refactoring, documentation, and testing.',
            'Skilled in prompt engineering to improve the quality and accuracy of AI-generated solutions.',
            'Ability to review, validate, and optimize AI-generated code for performance, security, and maintainability.',
            'Leverages AI tools to accelerate development while maintaining high code quality standards.',
        ],
    },
    {
