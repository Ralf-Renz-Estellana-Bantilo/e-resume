...
import OthersTab from '@/pages/components/tabs/others';
import PersonalTab from '@/pages/components/tabs/personal';
import ProjectsTab from '@/pages/components/tabs/projects';
